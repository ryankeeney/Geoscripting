...
#' of their spatial centers. Preserve the attributes of the parcels in each point.
#' @param polygon A spatialpolygonsdataframe.
#' @return "centroids" A spatialpointsdataframe of the centerspoints of the polygons.
...
PolyCentroid <- function(polygon){
  ...
  #Create a dataframe of the attributes of the polygons spatially joined with the locational info of the centroids that overlap them.
  ...
  prj <- CRS(coordrefsys)
  #Using the previously obtained info, generate a final spatialpointsdataframe from the centroids_temp2 dataframe.
